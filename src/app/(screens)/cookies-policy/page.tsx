      ...
      <Container>
        ...
        <Row>
          <Col sm={8} xs={12}>
            ...
            <br />
            <p className="page-text3">
              This Cookies Policy explains how AlabaMarketplace.ng ("we," "our,"
              "us") uses cookies and similar technologies to recognize you when
              you visit our website, mobile application, or related online
              services (collectively, the "Platform"). It also explains what
              these technologies are, why we use them, and your rights to
              control their use.
            </p>
            <p className="page-text3">
              By continuing to browse or use our Platform, you consent to the
            ...
            <p className="page-text3">
              ...
              smartphone, or other device when you visit a website. They help us
              make your experience more efficient by remembering your
              preferences, analyzing how the site is used, and improving our
              services.
            </p>
            <p className="page-text3">Cookies may be:</p>
            <ul className="page-text3">
              <li>
                <strong>Session Cookies</strong> – deleted automatically when
              ...
              <li>
                ...
                we use (e.g., Google Analytics, Facebook Pixel, or Paystack).
              </li>
            </ul>
            <br />
            ...
            <p className="page-text3">
              These are necessary for our Platform to function properly. They
              allow you to log in, manage your cart, make secure payments, and
              access protected areas.
            </p>
            <ul className="page-text3">
              <li>
                <strong>Example:</strong> session management, authentication,
                and account security cookies.
              </li>
            </ul>
            ...
            <p className="page-text3">
              ...
              site, which pages are most popular, and where users encounter
              issues.
            </p>
            <ul className="page-text3">
              <li>
                <strong>Example:</strong> Google Analytics cookies that track
                traffic sources, bounce rates, and user activity.
              </li>
            </ul>

            <h5 className="page-text2">c. Functionality Cookies</h5>
            <p className="page-text3">
              These cookies allow us to remember your preferences — such as
              language, location, or display settings — to enhance your browsing
              experience.
            </p>
            ...
            <p className="page-text3">
              ...
              measure the effectiveness of our marketing campaigns. They may be
              set by us or by third-party ad networks such as Meta
              (Facebook/Instagram) or Google Ads.
            </p>

            <h5 className="page-text2">e. Social Media Cookies</h5>
            <p className="page-text3">
              These cookies enable users to share content directly from our
              platform to their social media accounts or use embedded media
              (like videos or social share buttons).
            </p>
            <br />
            ...
            <p className="page-text3">
              Each third party is responsible for its own privacy and cookie
              practices. You can review their individual policies on their
              websites.
            </p>
            <br />
            ...
            <p className="page-text3">
              Please note that disabling certain cookies may impact your ability
              to use some features on AlabaMarketplace.ng, such as shopping
              carts, login sessions, or payment processing.
            </p>
            <p className="page-text3">
            ...
            <p className="page-text3">
              When you first visit AlabaMarketplace.ng, a cookie banner will
              appear asking you to accept or manage your cookie preferences. By
              clicking "Accept," you consent to the use of cookies as outlined
              in this policy.
            </p>
            <p className="page-text3">
              You may withdraw or change your consent at any time through our
              cookie management tool or your browser settings.
            </p>
            <br />
            ...
            <p className="page-text3">
              ...
              in technology, legal requirements, or our practices. The "Last
            ...
            <p className="page-text3">
              If you have questions about this Cookies Policy or how cookies are
              used on our Platform, please contact:
            </p>
            <p className="page-text3">
              <strong>Alaba Marketplace Data Protection Office</strong>
              <br />
