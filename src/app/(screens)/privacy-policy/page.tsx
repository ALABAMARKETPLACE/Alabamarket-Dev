...
function PrivacyPpolicy() {
  return (
    ...
    >
      ...
      <h4 className="page-text1">1. Information We Collect</h4>
      ...
      <h4 className="page-text1">2. How We Use Your Information</h4>
      ...
      <h4 className="page-text1">3. How We Share Your Information</h4>
      ...
      <h4 className="page-text1">4. Cookies and Tracking Technologies</h4>
      ...
      <h4 className="page-text1">5. Data Retention</h4>
      ...
      <h4 className="page-text1">6. Data Security</h4>
      <p className="page-text3">
        We use industry-standard security measures including SSL encryption, firewalls,
        and access controls. However, no system is 100% secure; users are encouraged to
        safeguard their login credentials.
      </p>

      <h4 className="page-text1">7. Your Rights</h4>
      <p className="page-text3">
      ...
      <h4 className="page-text1">8. Children's Privacy</h4>
      <p className="page-text3">
      ...
      <h4 className="page-text1">9. International Data Transfers</h4>
      <p className="page-text3">
        Your information may be transferred to and processed in countries other than
        Nigeria. We ensure appropriate safeguards are in place to protect your data
        in accordance with this Privacy Policy.
      </p>

      <h4 className="page-text1">10. Changes to This Policy</h4>
      <p className="page-text3">
        We may update this Privacy Policy periodically. Changes will be posted on this
        page with an updated revision date. Continued use of our Platform after changes
        indicates acceptance of the revised policy.
      </p>

      <h4 className="page-text1">11. Contact Us</h4>
      <p className="page-text3">
        For questions or concerns about this Privacy Policy or your data, please contact:
      </p>
      <p className="page-text3">
        <strong>Email:</strong> <a href="mailto:info@alabamarketplace.ng">info@alabamarketplace.ng</a><br />
        <strong>Email:</strong> <a href="mailto:support@taxgoglobal.com">support@taxgoglobal.com</a><br />
