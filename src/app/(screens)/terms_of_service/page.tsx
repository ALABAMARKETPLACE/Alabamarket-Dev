      ...
      <Container>
        ...
        <Row>
          <Col sm={8} xs={12}>
            ...
            <br />
            <p className="page-text3">
              Welcome to AlabaMarketplace.ng ("Alaba Marketplace," "we," "our,"
              or "us"). These Terms of Service ("Terms") govern your access to
            ...
            <p className="page-text3">
              AlabaMarketplace.ng is an online marketplace that connects
              verified sellers (primarily from the Alaba International Market
              and similar trading communities) with buyers across Nigeria and
              beyond. We provide the infrastructure for online sales, marketing,
              logistics integration, and secure payment processing — but we do
              not directly own or sell the products listed by independent
              merchants.
            </p>
            <br />
            ...
            <p className="page-text3">
              If you use the Platform on behalf of a business, you represent
            ...
            <ul className="page-text3">
              <li>
                You must create an account to list, buy, or sell on the
                Platform.
              </li>
              <li>
              ...
              <li>
                Alaba Marketplace reserves the right to suspend or terminate
                accounts that violate these Terms, engage in fraud, or
            ...
            <ul className="page-text3">
              <li>
                List only genuine, lawful, and accurately described products.
              </li>
              <li>
                Ensure all prices are displayed in Nigerian Naira (₦) and
                include applicable taxes or delivery fees.
              </li>
              <li>
                Deliver products as advertised and within agreed timelines.
              </li>
              <li>
                Honor refund or replacement policies in compliance with consumer
                protection laws.
              </li>
            </ul>
            <p className="page-text3">
              Prohibited products include, but are not limited to: counterfeit
              goods, illegal substances, firearms, adult material, and hazardous
              items.
            </p>
            <br />
            ...
            <ul className="page-text3">
              ...
              <li>
                Use the Platform lawfully and refrain from abusive or fraudulent
                conduct.
              </li>
            </ul>
            <br />
            ...
            <ul className="page-text3">
              <li>
                All payments are processed securely through licensed payment
                providers (e.g., Paystack, Flutterwave).
              </li>
              <li>
                Alaba Marketplace may charge transaction or service fees for
                listings, promotions, or sales.
              </li>
              <li>
                Sellers are responsible for any applicable taxes or levies.
              </li>
              <li>
                Refunds (where applicable) will follow our Refund & Dispute
                Resolution Policy.
              </li>
            </ul>
            <p className="page-text3">
              Alaba Marketplace does not store your card or banking information
              directly; such data is processed securely by third-party gateways.
            </p>
            <br />
            ...
            <ul className="page-text3">
              <li>
                Sellers may handle delivery themselves or use approved logistics
                partners (e.g., Parcel-King, GIG Logistics, DHL, etc.).
              </li>
              <li>Estimated delivery times are provided for guidance only.</li>
              <li>
                Alaba Marketplace is not liable for delays, damages, or losses
                once goods are in the custody of a logistics partner, though we
                may assist in resolving such disputes.
              </li>
            </ul>
            <br />
            ...
            <p className="page-text3">
              Alaba Marketplace may earn commissions from:
            </p>
            <ul className="page-text3">
              <li>Successful product sales</li>
              <li>Featured listings or promotional campaigns</li>
              <li>
                Subscription tiers (e.g., Standard, Silver, Gold, Platinum
                stores)
              </li>
            </ul>
            <p className="page-text3">
              Any fee structure changes will be communicated in advance through
              your registered email or dashboard notification.
            </p>
            <br />
            ...
            <ul className="page-text3">
              ...
              <li>
                Engage in fraud, money laundering, or illegal financial
                activities.
              </li>
            </ul>
            <p className="page-text3">
              Violations may result in account suspension, permanent removal, or
              legal action.
            </p>
            <br />
            ...
            <p className="page-text3">
              All content on the Platform — including logos, graphics, text, and
              software — is owned or licensed by AlabaMarketplace.ng. You may
              not reproduce, distribute, or use any content without prior
              written consent.
            </p>
            <p className="page-text3">
              However, sellers retain ownership of their trademarks, product
              photos, and descriptions uploaded to their stores.
            </p>
            <br />
            ...
            <ul className="page-text3">
              <li>
                Parties must first use the Platform's dispute resolution system.
              </li>
              <li>
                If unresolved, Alaba Marketplace's Dispute Panel will mediate.
              </li>
              <li>
                If still unresolved, the matter shall be referred to arbitration
                in Lagos State, Nigeria, under the Arbitration and Conciliation
            ...
            <p className="page-text3">
              Alaba Marketplace acts as a facilitator, not the actual seller. We
              are not liable for:
            </p>
            <ul className="page-text3">
            ...
            <p className="page-text3">
              In no event shall our total liability exceed the value of the
            ...
            <p className="page-text3">
              ...
              support@taxgoglobal.com or info@alabamarketplace.ng
            </p>
            <br />
            ...
            <p className="page-text3">
              We may modify these Terms periodically. Updates will be posted on
              this page and take effect upon publication. Continued use of the
