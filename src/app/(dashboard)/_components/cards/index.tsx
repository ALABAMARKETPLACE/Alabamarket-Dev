...
function Cards({
  ...
  const getColorClass = () => {
    switch (color) {
      case "success":
        return "dashboard-stat-card--success";
      case "warning":
        return "dashboard-stat-card--warning";
      case "danger":
        return "dashboard-stat-card--danger";
      case "info":
        return "dashboard-stat-card--info";
      default:
        return "dashboard-stat-card--primary";
    }
  };
  ...
  return (
    ...
    >
      <div className="dashboard-stat-card__header">
        <div className="dashboard-stat-card__icon-wrapper">{icon}</div>
        {trend && trendValue && (
          <div
