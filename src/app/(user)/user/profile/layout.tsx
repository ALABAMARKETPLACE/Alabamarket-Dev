...
const EditEmail               = dynamic(() => import("./_components/editEmail"));
const EditName                = dynamic(() => import("./_components/editName"));
const PhoneVerifyOtp          = dynamic(() => import("./_components/phoneVerify"));
const DeactivateModal         = dynamic(() => import("./_components/deactivateModal"));
const EditProfilePhoto        = dynamic(() => import("./_components/editProfilePhoto"));
const EditPassword            = dynamic(() => import("./_components/updatePassword"));
const EmailVerificationModal  = dynamic(() => import("./_components/emailVerficationModal"));
const EditNameChange          = dynamic(() => import("./_components/editNameChange"));
const EditEmailChange         = dynamic(() => import("./_components/editEmailChange"));
const EditMobilenumberChange  = dynamic(() => import("./_components/editMobilenumberChange"));
const EditPasswordChange      = dynamic(() => import("./_components/editPasswordChange"));
